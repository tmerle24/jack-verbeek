...
| Kapitel | Fixpunkt |
|---|---|
| 1–5 | ✅ Geschrieben. Kolbe-Call, Fontaine, Anruf Marie, Beweis (Tippfehler), Jack antwortet dem System. |
| 6–12 | Akt 1 zu Ende: Jacks Gegenzüge zu Hause, sein eigener Code erkannt, Abflug in die Karibik. |
| 13–24 | Martinique, dann Guadeloupe. Der Ort des Todes, die Spur der Bibliothek, Jacks Vergangenheit. Ritual-Miniatur: Ukulele allein auf fremder Veranda. |
| 25–35 | Die Werkstatt: Voss holt Jack „leihweise" ins Boot. Ausmaß sichtbar: 28 Läufe. Fontaines Feldmann. |
| 36–49 | Eskalation. Das System fasst Jacks Leben an. ~Kap 40: die Fontaine-Szene, in der der Leser ihm drei Sätze lang zustimmt (Pflicht aus der Bible). |
| **50** | **Midpoint: Nele bekommt eine Sprachnachricht von „Papa", die Jack nie gesprochen hat.** |
| 51–68 | Heimatschock aus der Ferne. ~Kap 54: Musikritual #2 per Videocall, brüchig. Jack begreift: Er ist Lauf 29. Die Bandbreiten-Spur führt nach Kourou. |
...
- **8 — Marie.** Trauerbürokratie in Karlsruhe: Ein Toter hat zwölf Tage lang unterschrieben. In Kolbes Unterlagen ein Vertrag mit einer Firma für „digitale Nachlassverwaltung" (Name offen — Spur zu Fontaines alter Firma).
- **9 — Jack.** Die Kiste im Keller: alte Guadeloupe-Festplatten, sein Code von damals, der Freitagabend-Kommentar `TODO: Fehlerverteilung echt modellieren — Montag`. Es war nie Montag geworden. Kante: Er fand den Tippfehler, weil er ihn selbst programmiert hat.
